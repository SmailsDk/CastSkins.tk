...
@section('content')
    ...
    <div class="col-lg-24 text-center roulette_top">
        ...
        <div id="timer"><span class="timerTime">40</span>s</div>
    ...
    <div class="col-lg-24 roulette_bets">
        <div class="container">
            <div class="col-md-6">
                ...
                <div class="user_bet">Total bet : <span id="redTotal">0</span></div>
            ...
            <div class="col-md-6">
                ...
                <div class="user_bet">Total bet : <span id="blackTotal">0</span></div>
                <table class="table table-hover tableusers" style="border:0;">
                    <tbody id="blackUsers">
            ...
            <div class="col-md-6">
                <button class="place_bet green" onclick="placeBET($('#betammount').val(), 'green')">Green x14</button>
                <div class="user_bet">Your bet : <span class="user_green">0</span></div>
                <div class="user_bet">Total bet : <span id="greenTotal">0</span></div>
                <table class="table table-hover tableusers" style="border:0;">
                    <tbody id="greenUsers">
            ...
            <div class="col-md-6">
                ...
                <div class="user_bet">Total bet : <span id="goldTotal">0</span></div>
                <table class="table table-hover tableusers" style="border:0;">
                    <tbody id="goldUsers">
